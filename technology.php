...
$f_json = '\\10.147.11.242\contact_centr\Балов\parsing\graph\df_piv3.json';
...
{
    $checkTown = $obj['data'][$countRecords]['Технология'];
    $checkProblem = $obj['data'][$countRecords]['Технология'];
